...
function clearFilter() {
    // document.getElementById("composer").value = ""; // Очищаем поле ввода
    // document.getElementById("nationalitySelect").value = "";
    // document.getElementById("minYearInput").value = "";
    // document.getElementById("maxYearInput").value = "";

    // var container = d3.select("#data_display");
    // container.html(""); // Очищаем контейнер для отфильтрованных данных

    // // Вывод всех данных заново
    // displayData(data)
 ...
 function filterData() {
    ...
    var searchTerm = document.getElementById("composers").value.toLowerCase();
